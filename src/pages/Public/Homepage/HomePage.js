            ...
            <Container width="100%" sx={{ display: "flex" }}>
              ...
              >
                ...
                <Typography variant="subtitle1">
                  Pick the brains of mentors who have driven growth at some of
                  the world's leading startups. See the blind spots in your
                  decision-making
                </Typography>
          ...
          <section className="mentor__section">
            ...
            >
              <Typography variant="h5">
                Get instant access to startup mentors from amazing companies
                like:
              </Typography>
              <Stack
                flexDirection="row"
